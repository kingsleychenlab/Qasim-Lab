...
def main():
    ...
    parser.add_argument("--input", default="peers_words.csv")
    parser.add_argument("--out-matrix", default="peers_t5large_embeddings.npy")
    parser.add_argument("--out-order", default="peers_word_order.csv")
    parser.add_argument("--out-csv", default="peers_t5large_embeddings.csv")
    parser.add_argument("--out-metadata", default="embedding_metadata.json")
