#!/usr/bin/env python3
"""
Stage C — validate the model inputs (X_eeg, Y_t5, trial_metadata) before any
modeling. Read-only. No ridge regression, no analysis.

Writes a full report to outputs/model_input_validation.txt.
"""
