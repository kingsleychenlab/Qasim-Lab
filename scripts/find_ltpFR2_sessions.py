...
This script:
  ...
  4. Runs scripts/inspect_ds004395.py on that session.
  5. Runs scripts/create_encoding_trials.py on that session.
...
def main():
    ...
    # ------------------------------------------------------------------
    run([PY, os.path.join(HERE, "scripts", "download_one_session.py"),
    ...
    run([PY, os.path.join(HERE, "scripts", "inspect_ds004395.py"),
    ...
    run([PY, os.path.join(HERE, "scripts", "create_encoding_trials.py"),
    ...
    print(f"REC_WORD count         : (see summary) recalled+forgotten below")
